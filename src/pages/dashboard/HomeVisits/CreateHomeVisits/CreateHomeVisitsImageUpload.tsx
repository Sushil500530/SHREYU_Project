...
const CreateHomeVisitsImageUpload = (props: FileUploaderProps) => {
    ...
    <>
      ...
      >
        {({ getRootProps, getInputProps }) => (
          <div>
            <div {...getRootProps()}>
              <div className="dz-message needsclick cursor-pointer border m-0">
                <input {...getInputProps()} className="border" />
                <h5 className="d-flex align-items-center p-2 text-black justify-content-start sw-normal  m-0">
                  Choose file
                </h5>
              </div>
              {props.showPreview &&
...
CreateHomeVisitsImageUpload.defaultProps = {
  showPreview: true,
};

export default CreateHomeVisitsImageUpload;
